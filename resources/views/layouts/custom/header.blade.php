            ...
            <!-- Nav Toggle Button -->
                ...
                <div class="extra-nav">
                    <div class="extra-cell">
                        <a href="{{route('confirm')}}" class="btn btn-primary">Aracımı Satmak İstiyorum<i
                    ...
                    @if(!\Illuminate\Support\Facades\Auth::guard('customer')->check())
                        <!-- a href="javascript:;" ng-click="CustomerLoginForm()" class="btn btn-info">Giriş Yap<i class="fa fa-angle-right m-l10"></i></a -->
                            <a href="{{route('authpage')}}" class="btn btn-info">Giriş Yap<i
                                        class="fa fa-angle-right m-l10"></i></a>
                        @else
                            <a href="{{route('profil')}}" style="color: #fff" class="btn btn-warning">Hesabım<i
                                        class="fa fa-angle-right m-l10"></i></a>
                        @endif
                    </div>
                </div>
                <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                    ...
                    <ul class="nav navbar-nav navbar">
                        ...
                        <li class=""><a href="{{route('kurumsal',['slug' => 'kurumsal'])}}"><span>Kurumsal</span></a>
                        </li>
                        <li class=""><a href="{{route('nasil_calisir')}}"><span>Nasıl Çalışır</span></a></li>
                        <li class=""><a href="{{route('kullanici_gorusleri')}}"><span>Kullanıcı Görüşleri</span></a>
                        </li>
                        <li class=""><a href="/iletisim"><span>İletişim</span></a></li>
                        @if(!\Illuminate\Support\Facades\Auth::guard('customer')->check())
                            <li class="d-sm-none" style="padding: 0;"><a href="{{route('authpage')}}"
                                                                         style="padding: 10px 20px;" class="btn-info">Giriş
                                    Yap<i class="fa fa-angle-right m-l10"></i></a></li>
                        @else
                            <li class="d-sm-none" style="padding: 0;"><a href="{{route('profil')}}"
                                                                         style="padding: 10px 20px;"
                                                                         class="btn-warning">Hesabım<i
                                            class="fa fa-angle-right m-l10"></i></a></li>
                        @endif
                    </ul>
