                                        ...
                                        <div class="icon-content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align: left"><h5
                                                            class="dlab-title">{{$follow->customer_car->car->name }}</h5>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4"
                                                    ...
                                                    <img
                                                            ...
                                                            style="float:left;width: 20px;height: 20px;"/> {{  \App\Enums\Transmission::Transmission[$follow->customer_car->gear] }}
                                                </div>
                                                <div class="col-md-4"
                                                     style="text-align: left;font-size: 14px;  overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">
                                                    <img
                                                            src="{{asset('view/icons/fuel.png')}}"
                                                            style="float:left;width: 20px;height: 20px;"/>{{  \App\Enums\FullType::FullType[$follow->customer_car->fuel] }}
                                                </div>
                                                <div class="col-md-4"
                                                     style="text-align: left;  overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">
                                                    <img
                                                            src="{{asset('view/icons/calendar.png')}}"
                                                            style="float:left;width: 20px;height: 20px;"/> {{ $follow->customer_car->caryear }}
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 m-t10">
                                                    <button ng-click="CustomerCarUnFollow({{$follow->id}})"
                                                            type="button"
