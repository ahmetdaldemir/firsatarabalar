...
class CustomerCarValuationRepository implements CustomerCarValuationInterface
{

    public function get()
    {
        return CustomerCarValuation::orderBy('id', 'desc')->simplePaginate(50);
    }

    public function getDistrict($id)
    {
        return CustomerCarValuation::where('city_id',$id)->get();
    }

    public function getById($id)
    {
        return CustomerCarValuation::findOrFail($id);
    }

    public function delete($id)
    {
        return CustomerCarValuation::destroy($id);
    }

    public function create($request)
    {
        $customer_car_valuation = new CustomerCarValuation();
    ...
    {
        $customer_car_valuation = CustomerCarValuation::find($id);
        $customer_car_valuation->comment=$request->comment;
        $customer_car_valuation->link1=$request->link1;
        $customer_car_valuation->link1_comment=$request->link1_comment;
        $customer_car_valuation->link2=$request->link2;
