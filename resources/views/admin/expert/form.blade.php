...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col">
            <h2>Danışman {{(@$expert) ? "Düzenle":"Ekle"}}</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/">Ana Sayfa</a></li>
                <li class="breadcrumb-item"><a href="{{route('admin.expert.index')}}">Danışmanlar</a></li>
                <li class="breadcrumb-item active"><strong>Danışman {{(@$expert) ? "Düzenle":"Ekle"}}</strong></li>
            </ol>
        </div>
                    ...
                    <div class="panel-body p-4">
                        <form action="{{route('admin.expert.store')}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="firstname">Danışman İsmi <span class="text-danger">*</span></label>
                                        <input type="text" name="firstname" id="firstname" class="form-control" value="{{@$expert->firstname}}" placeholder="Danışman ismi yazın..." autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="lastname">Danışman Soysmi <span class="text-danger">*</span></label>
                                        <input type="text" name="lastname" id="lastname" class="form-control" value="{{@$expert->lastname}}" placeholder="Danışman soyismi yazın..." autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="col"></div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="email">Danışman E-Posta <span class="text-danger">*</span></label>
                                        <input type="text" name="email" id="email" class="form-control" value="{{@$expert->email}}" placeholder="Danışman e-posta adresi yazın..." autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="phone">Danışman Telefonu <span class="text-danger">*</span></label>
                                        <input type="text" name="phone" id="phone" class="form-control" value="{{@$expert->phone}}" placeholder="Danışman telefonu yazın..." autocomplete="off" required>
                                    </div>
                                </div>
                                <div class="col"></div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="password">Danışman Şifresi <span class="text-danger">*</span></label>
                                        <input type="text" name="password" id="password" class="form-control" placeholder="Danışman şifresi yazın..." autocomplete="off" {{( @$expert->id == "" ) ? "required" : ""}}>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="earn" id="earn" class="form-control text-right" value="{{@$expert->earn}}" placeholder="0.00" min="0.00" max="10000.00" step="0.01" style="max-width: 100px" autocomplete="off" required>
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" name="status" class="custom-control-input" value="1" id="status" {{ ( @$expert == "" or @$expert->status ) ? "checked" : "" }}>
                            ...
                            <div class="buttons">
                                <button type="submit" class="btn btn-sm btn-primary mr-1"><i class="fad fa-save mr-1"></i> Danışmanı Kaydet</button>
                    ...
                    <div class="panel-body p-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div>
                                <form action="#earnings" method="get" class="custom d-flex justify-content-end align-items-center">
                                    ...
                                    @if ( Request::get("m") )
                                        <a href="/agents/{{$expert->id}}/{{$expert->slug}}#earnings" class="btn btn-sm btn-warning ml-1"><i class="fad fa-sync"></i></a>
                                    @endif
                        ...
                        <table class="table table-striped table-bordered table-hover mb-0 bg-white" id="Earnings">
                            ...
                            <tr>
                                ...
                                <td class="text-right text-success">{{$expert->expert_earnings()->count()}} </td>
                                <td>{{$expert->expert_earnings_sum()}} ₺</td>
                            </tr>
                            </tfoot>
                        </table>
                        @endif
