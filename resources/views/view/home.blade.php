        ...
        <div class="container-fluid">
            ...
            <div class="clearfix">
                <ul id="masonry" class="row lightgallery">
                    <li class="card-container col-lg-3 col-md-6 col-sm-6 web_design wow fadeInUp" data-wow-duration="2s"
                        data-wow-delay="0.2s">
    ...
    <section class="overlay-secondary-middle bg-img-fix"
        ...
        <div class="container">
            <div class="row action-box style-1  align-items-center">
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 text-end wow fadeIn" data-wow-duration="2s"
                     data-wow-delay="0.4s">
