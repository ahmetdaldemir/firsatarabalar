...
class Est3DModel
{
    ...
    {
        $this->live_url = "https://sanalpos.isbank.com.tr/fim/est3Dgate";
        $this->api_url = "https://sanalpos.isbank.com.tr/fim/est3Dgate";
        $this->client_id = "700674860028";
        $this->storekey = "@198711Ad@";
        $this->name = "parababasiadmin";
        $this->password = "@198711Ad@";
        $this->mode = "T";          //P olursa gerçek islem, T olursa test islemi yapar
